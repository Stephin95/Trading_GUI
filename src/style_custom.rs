    ...
    impl iced::container::StyleSheet for Cell {
        fn style(&self) -> Style {
            Style {
                ...
                background:Some(Background::Color(Color::from_rgb8(31, 29, 54))),
                ..Default::default()
            }
        }
    }
    ...
    //     fn style(&self)-> Style{
    //         Style { text_color: Some(Color::WHITE), background: Some(Background::Color(Color::BLACK)),..Default::default() 
